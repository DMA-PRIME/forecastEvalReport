...
#------------------------------------------------------------------------------#
  ...
  methods_accordion <- paste0(
    ...
    'Both changes are classified with the same observed location-specific 5th, 25th, 75th, and 95th percentile cut points, and a raw weekly change smaller than the configured stability threshold is labelled Stable.</p>',
