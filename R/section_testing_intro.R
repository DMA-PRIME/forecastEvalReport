...
#' top of the testing-period evaluation section: similarity index, forecast
  ...
  <div style="font-family: sans-serif; padding: 1rem 0 0.75rem;">
    ...
    <div style="display: flex; flex-direction: column; gap: 10px; padding-left: 2rem;">
      ...
      <div style="display: flex; align-items: center; gap: 12px;">
        ...
        <p style="font-size: 14px; line-height: 1.7; color: #444; margin: 0;">
          <strong>Statistical Scoring Metrics:</strong> supporting scores. Mean absolute error (MAE) is a secondary point-forecast measure. The
          ...
          forecast</strong> summarizes point accuracy, while <strong>50%, 80%, and 95%
      ...
      <!-- 4. Peak-phase timing -> calculating_peak_trough_PEAKPHASE() -->
      <div style="display: flex; align-items: center; gap: 12px;">
        <span style="min-width: 22px; height: 22px; border-radius: 50%; background-color: #C9B8E8;
                     color: #fff; font-size: 11px; font-weight: 700; display: flex; flex-shrink: 0;
        ...
        <p style="font-size: 14px; line-height: 1.7; color: #444; margin: 0;">
          ...
          time with the observed maximum within the testing period.
        </p>
      </div>

      <!-- 5. Peak-phase intensity -> calculating_peak_trough_PEAKPHASE() -->
      <div style="display: flex; align-items: center; gap: 12px;">
        <span style="min-width: 22px; height: 22px; border-radius: 50%; background-color: #C9B8E8;
                     color: #fff; font-size: 11px; font-weight: 700; display: flex; flex-shrink: 0;
      ...
      <!-- 6. Trend- and phase-specific performance -> the trendPhase* family, shown
           as a breakdown inside the Percent Accuracy (Similarity Index), Forecast Bias, and
      ...
      <div style="display: flex; align-items: center; gap: 12px;">
        ...
        <p style="font-size: 14px; line-height: 1.7; color: #444; margin: 0;">
          <strong>Trend and Phase Specific Performance:</strong> similarity index, bias,
          and statistical scores broken out by observed trend and retrospective
          testing-period phase &mdash; ascension, peak, and decline &mdash; within each metric section.
        </p>
      </div>
